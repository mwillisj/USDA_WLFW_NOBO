...
ggplot(st_as_sf(transf_natl_PA)) +
  geom_sf()


#Hatching priority areas
priority.hatch <- HatchedPolygons::hatched.SpatialPolygons(natl_priority_map, 
                                                           density = c(6,4),
                                                           angle = c(45, 135))
...
addLegend(title = paste("Trend 2002-2019<br>(% change/yr)"), 
                 pal= numPal,
