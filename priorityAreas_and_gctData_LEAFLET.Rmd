...
numPal <- colorNumeric("viridis", bird_dat$trend)

pal
  
  #c("firebrick1","limegreen"), 
   #                 domain = bins,
    #                na.color = "#00000000")
...
symbols_abund <- makeSizeIcons(pal = numPal,
...
addLegend("topright", pal= numPal, labels= c("little", "", "", "", "alot"), values=c(-3,-2,-1,0,1)) %>%
